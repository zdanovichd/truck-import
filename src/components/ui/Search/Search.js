...
export default function Search({ style, value, onChange, onFocus, onBlur, rightSlot, placeholder = "Введите номер детали" }) {
    const isControlled = value !== undefined && onChange !== undefined;
    return (
        <div className={styles.search} style={style} role="search">
            <input
